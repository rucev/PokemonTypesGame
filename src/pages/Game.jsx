        ...
        <main>
            <section className="game__selections">
                <button className="game__selection" data-selection="fire">
                    <img className="game__selection--image" src="../../assets/images/fire.webp" alt="fire" onClick={() => makeSelection(SELECTIONS[0])}/>
                </button>
                <button className="game__selection" data-selection="water">
                    <img className="game__selection--image" src="../../assets/images/water.webp" alt="water" onClick={() => makeSelection(SELECTIONS[1])}/>
                </button>
                <button className="game__selection" data-selection="plant">
                    <img className="game__selection--image" src="../../assets/images/plant.webp" alt="plant" onClick={() => makeSelection(SELECTIONS[2])}/>
                </button>
                <button className="game__selection" data-selection="ice">
                    <img className="game__selection--image" src="../../assets/images/ice.webp" alt="ice" onClick={() => makeSelection(SELECTIONS[3])}/>
                </button>
                <button className="game__selection" data-selection="rock">
                    <img className="game__selection--image" src="../../assets/images/rock.webp" alt="rock" onClick={() => makeSelection(SELECTIONS[4])}/>
                </button>
            </section>
